  ...
  <body style="background:maroon;">
    <div class="row">
      <div class="col-md-4">
        <div class="card">
          <div class="card-header">
            <b>Timings To Followed</b>
          </div>
          <div class="card-body">
            <b>Breakfast:</b> 8:00 AM to 9:00 AM <br><br>
            <b>Lunch:</b> 12:00 PM to 2:00 PM <br><br>
            <b>Snaks:</b> 4:00 PM to 5:00 PM <br><br>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <?php
              ...
              while($row = mysqli_fetch_assoc($query_run)){
            ?>
              <b>Breakfast: </b> <?php echo $row['meal1']; ?> <br><br>
              <b>Lunch: </b> <?php echo $row['meal2']; ?> <br><br>
              <b>Snacks: </b> <?php echo $row['meal3']; ?> <br><br>
              <b>Dinner: </b> <?php echo $row['meal4']; ?>
            <?php } ?>
          </div>
          <div class="card-footer">
      ...
      <div class="col-md-5">
        <div class="card">
          <div class="card-header">
            <b>Notice And Giudelines</b>
          </div>
          <div class="card-body">
              Follow covid rules and wear a mask <br>
              Always be on time <br>
              Keep good hygiene <br>
              Dont talk while eating <br>
              Pay fees if someone has not paid yet <br>
              Do give feedback <br>
              Follow covid rules and wear a mask <br>
              Always be on time <br>
               <br>
    ...
    <div class="row">
      <div class="col-md-12 m-auto">
        <a href="edit_profile.php" type="button" class="btn btn-block btn-warning">Make Changes To Profile</a>
        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#fee_status_modal">View Fee Status</button>
        <a href="feedback.php" type="button" class="btn btn-block btn-danger">Give Feedback To Mess</a>
      </div>
    </div>
