...
<html lang="en" dir="ltr">
  ...
  <body style="background:url('images/mess-img7.jpg');">
    <!-- Navbar -->
    <nav class="navbar navbar-expand-lg" style="background-color:#194350;">
  		<div class="container-fluid">
  			<a class="navbar-brand" href="index.php"><h3 style="color:Yellow;">Graphic Era Hostel Mess Management System</h3></a>
